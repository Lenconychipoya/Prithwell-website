    ...
    <footer style={{ background: '#0a1628' }} className="text-gray-400 mt-20">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="mt-4 space-y-1 text-xs" style={{ color: '#8899bb' }}>
            <div>📍 Corner Kaguvi &amp; Bute Street</div>
            <div style={{ paddingLeft: '1.2rem' }}>Kaguvi City Mall, 1st Floor, Shop F30</div>
            <div className="mt-2">📱 <a href="tel:+263773895255" className="hover:text-white transition-colors">+263 773 895 255</a></div>
            <div>✉️ <a href="mailto:prithwellmotorspares@gmail.com" className="hover:text-white transition-colors">prithwellmotorspares@gmail.com</a></div>
