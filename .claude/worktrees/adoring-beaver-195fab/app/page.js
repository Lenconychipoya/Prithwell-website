        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl">
            <div
              ...
              style={{ background: 'rgba(245,197,0,0.12)', color: '#f5c500', border: '1px solid rgba(245,197,0,0.25)' }}
            >
              <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: '#f5c500' }}/>
            ...
            <h1 className="font-display text-white text-4xl md:text-6xl font-bold leading-tight mb-5">
              Quality Auto Parts,
              <br/>
              <span style={{ color: '#f5c500' }}>Delivered Fast.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {[['408+', 'Parts in stock'], ['14', 'Vehicle makes'], ['Harare', '1–2 day delivery']].map(([val, label]) => (
                <div key={label}>
                  <div className="font-display font-bold text-2xl" style={{ color: '#f5c500' }}>{val}</div>
