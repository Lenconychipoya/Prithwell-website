    ...
    <div>
      ...
      <section className="relative overflow-hidden" style={{ background: '#0a1628' }}>
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16 md:py-20">
          <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: '#c9a227' }}>About Us</p>
          <h1 className="font-display text-white text-4xl md:text-5xl font-bold leading-tight mb-4">
            Harare&rsquo;s Trusted<br/>
            <span style={{ color: '#c9a227' }}>Auto Parts Supplier</span>
          </h1>
      ...
      {/* Stats */}
      <section style={{ background: '#c9a227' }}>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: '#c9a227' }}>Our Story</p>
      ...
      <section style={{ background: '#f9fafb' }} className="py-14">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-xs font-medium tracking-widest uppercase mb-2" style={{ color: '#c9a227' }}>Why Choose Us</p>
            <h2 className="font-display text-gray-900 text-3xl font-bold">The Prithwell Difference</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {WHY_US.map(item => (
              <div key={item.title} className="card p-6">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{ background: '#0a1628', color: '#c9a227' }}>
                  {item.icon}
                </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: '#c9a227' }}>Find Us</p>
            <h2 className="font-display text-gray-900 text-3xl font-bold mb-6">Visit Our Store</h2>
            <div className="space-y-4">
              {[
                { label: 'Address', value: 'Corner Kaguvi & Bute Street, Kaguvi City Mall, 1st Floor, Shop F30', icon: '📍' },
                { label: 'Phone / WhatsApp', value: '+263 773 895 255', icon: '📱' },
                { label: 'Email', value: 'prithwellmotorspares@gmail.com', icon: '✉️' },
